                                                ...
                                                <div className="flex-1 overflow-auto border border-slate-200 rounded-xl bg-slate-300 p-6 flex justify-center min-h-[600px]">
                                                    ...
                                                    {rkkMenu === 'pakta' && (
                                                        <div className="a4-portrait font-mono text-[9px] text-slate-800 leading-relaxed shadow-lg p-10">
                                                            <div className="font-bold text-[10px] mb-4">A. Kepemimpinan dan Partisipasi Pekerja dalam Keselamatan Konstruksi<br/>A.1 Komitmen Keselamatan Konstruksi</div>
...
console.log("Workspace.jsx Phase 2 updated (RKK with complete PDF Formats).");
